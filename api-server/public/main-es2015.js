...
let CartComponent = class CartComponent {
    constructor(authService, utility, narrationService) {
    ...
    book(flight) {
        ...
        let user = this.utility.getUser();
        let url = "/api/user/" + user + "/flights";
        this.narrationService.addPre("Authenticated POST to " + url, "The payload was:", JSON.stringify(flights));
        return this.utility.makePostRequest(url, [], flights, true).then((response) => {
            let data = _shared__WEBPACK_IMPORTED_MODULE_1__["UtilityService"].extractData(response);
            let narration = _shared__WEBPACK_IMPORTED_MODULE_1__["UtilityService"].extractNarration(response);
            this.remove(flight);
...
CartComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_shared__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _shared__WEBPACK_IMPORTED_MODULE_1__["UtilityService"], _shared__WEBPACK_IMPORTED_MODULE_1__["NarrationService"]])
], CartComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _cart_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart.component */ "./src/app/+cart/cart.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CartComponent", function() { return _cart_component__WEBPACK_IMPORTED_MODULE_0__["CartComponent"]; });
...
let HomeComponent = class HomeComponent {
    constructor(auth, utility, narrationService) {
        this.to = '';
        this.from = '';
        this.leaves = '';
        this.returns = null;
    ...
    getToAirport() {
        return this.utility.makeGetRequestObs("/api/airports?search=" + this.to, [])
            .map((result) => {
            let data = _shared__WEBPACK_IMPORTED_MODULE_1__["UtilityService"].extractData(result);
            let narration = _shared__WEBPACK_IMPORTED_MODULE_1__["UtilityService"].extractNarration(result);
    ...
    findFlights(from, to, leaves, returns) {
...
/* harmony import */ var _shared_utility_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/utility.service */ "./src/app/shared/utility.service.ts");
/* harmony import */ var _shared_narration_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../shared/narration.service */ "./src/app/shared/narration.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let HotelsComponent = class HotelsComponent {
    constructor(fb, utility, narrationService) {
...
HotelsComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-hotels',
        template: __importDefault(__webpack_require__(/*! raw-loader!./hotels.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/+hotels/hotels.component.html")).default
    }),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _shared_utility_service__WEBPACK_IMPORTED_MODULE_2__["UtilityService"], _shared_narration_service__WEBPACK_IMPORTED_MODULE_3__["NarrationService"]])
], HotelsComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hotels_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hotels.component */ "./src/app/+hotels/hotels.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HotelsComponent", function() { return _hotels_component__WEBPACK_IMPORTED_MODULE_0__["HotelsComponent"]; });
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_shared__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
], LoginComponent);
...
UserComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_shared__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _shared__WEBPACK_IMPORTED_MODULE_1__["UtilityService"]])
], UserComponent);
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _shared__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])
], AppComponent);
...
let OnlyLoggedInGuard = class OnlyLoggedInGuard {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
...
OnlyLoggedInGuard.ctorParameters = () => [
    { type: _shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
];
OnlyLoggedInGuard = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    __metadata("design:paramtypes", [_shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
], OnlyLoggedInGuard);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OnlyNotLoggedInGuard", function() { return OnlyNotLoggedInGuard; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _shared_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/auth.service */ "./src/app/shared/auth.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
let OnlyNotLoggedInGuard = class OnlyNotLoggedInGuard {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
...
OnlyNotLoggedInGuard.ctorParameters = () => [
    { type: _shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
];
OnlyNotLoggedInGuard = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    __metadata("design:paramtypes", [_shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
...
/* harmony import */ var ngx_bootstrap_typeahead__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-bootstrap/typeahead */ "./node_modules/ngx-bootstrap/typeahead/fesm2015/ngx-bootstrap-typeahead.js");
/* harmony import */ var _app_routes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app.routes */ "./src/app/app.routes.ts");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared */ "./src/app/shared/index.ts");
/* harmony import */ var _app_guards_auth__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./app.guards.auth */ "./src/app/app.guards.auth.ts");
/* harmony import */ var _app_guards_notlogged__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./app.guards.notlogged */ "./src/app/app.guards.notlogged.ts");
...
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./+user */ "./src/app/+user/index.ts");
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./+cart */ "./src/app/+cart/index.ts");
/* harmony import */ var _hotels__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./+hotels */ "./src/app/+hotels/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _shared__WEBPACK_IMPORTED_MODULE_7__["NavbarComponent"],
            _shared__WEBPACK_IMPORTED_MODULE_7__["NarrationComponent"],
            _home__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"],
            _login__WEBPACK_IMPORTED_MODULE_11__["LoginComponent"],
            _user__WEBPACK_IMPORTED_MODULE_12__["UserComponent"],
            _cart__WEBPACK_IMPORTED_MODULE_13__["CartComponent"],
            _hotels__WEBPACK_IMPORTED_MODULE_14__["HotelsComponent"]
        ],
        imports: [
            ...
            ngx_bootstrap_typeahead__WEBPACK_IMPORTED_MODULE_4__["TypeaheadModule"]
        ],
        providers: [
            _shared__WEBPACK_IMPORTED_MODULE_7__["AuthService"],
            _shared__WEBPACK_IMPORTED_MODULE_7__["UtilityService"],
            _shared__WEBPACK_IMPORTED_MODULE_7__["NarrationService"],
            _app_guards_auth__WEBPACK_IMPORTED_MODULE_8__["OnlyLoggedInGuard"],
            _app_guards_notlogged__WEBPACK_IMPORTED_MODULE_9__["OnlyNotLoggedInGuard"]
        ],
...
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./+user */ "./src/app/+user/index.ts");
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./+cart */ "./src/app/+cart/index.ts");
/* harmony import */ var _hotels__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./+hotels */ "./src/app/+hotels/index.ts");
/* harmony import */ var _app_guards_auth__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app.guards.auth */ "./src/app/app.guards.auth.ts");
/* harmony import */ var _app_guards_notlogged__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./app.guards.notlogged */ "./src/app/app.guards.notlogged.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
const routes = [
    { path: '', component: _home__WEBPACK_IMPORTED_MODULE_1__["HomeComponent"], canActivate: [_app_guards_auth__WEBPACK_IMPORTED_MODULE_6__["OnlyLoggedInGuard"]] },
    { path: 'home', component: _home__WEBPACK_IMPORTED_MODULE_1__["HomeComponent"], canActivate: [_app_guards_auth__WEBPACK_IMPORTED_MODULE_6__["OnlyLoggedInGuard"]] },
    { path: 'login', component: _login__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"], canActivate: [_app_guards_notlogged__WEBPACK_IMPORTED_MODULE_7__["OnlyNotLoggedInGuard"]] },
    { path: 'user', component: _user__WEBPACK_IMPORTED_MODULE_3__["UserComponent"], canActivate: [_app_guards_auth__WEBPACK_IMPORTED_MODULE_6__["OnlyLoggedInGuard"]] },
    { path: 'cart', component: _cart__WEBPACK_IMPORTED_MODULE_4__["CartComponent"], canActivate: [_app_guards_auth__WEBPACK_IMPORTED_MODULE_6__["OnlyLoggedInGuard"]] },
    { path: 'hotels', component: _hotels__WEBPACK_IMPORTED_MODULE_5__["HotelsComponent"], canActivate: [_app_guards_auth__WEBPACK_IMPORTED_MODULE_6__["OnlyLoggedInGuard"]] }
];
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthHttp", function() { return AuthHttp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JwtHelper", function() { return JwtHelper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tokenNotExpired", function() { return tokenNotExpired; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let AuthHttp = class AuthHttp {
    constructor(options, http) {
        ...
        this.tokenStream = new rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"]((obs) => {
    ...
    request(url, options) {
        ...
        if (!tokenNotExpired(null, this._config.tokenGetter())) {
            if (!this._config.noJwtError) {
                return new rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"]((obs) => {
    ...
    requestHelper(requestArgs, additionalOptions) {
        let options = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestOptions"](requestArgs);
    ...
    get(url, options) {
        return this.requestHelper({ url: url, method: _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestMethod"].Get }, options);
    }
    post(url, body, options) {
        return this.requestHelper({ url: url, body: body, method: _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestMethod"].Post }, options);
    }
    put(url, body, options) {
        return this.requestHelper({ url: url, body: body, method: _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestMethod"].Put }, options);
    }
    delete(url, options) {
        return this.requestHelper({ url: url, method: _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestMethod"].Delete }, options);
    }
    patch(url, body, options) {
        return this.requestHelper({ url: url, body: body, method: _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestMethod"].Patch }, options);
    }
    head(url, options) {
        return this.requestHelper({ url: url, method: _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestMethod"].Head }, options);
    }
};
...
AuthHttp = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    __metadata("design:paramtypes", [AuthConfig, _angular_http__WEBPACK_IMPORTED_MODULE_1__["Http"]])
], AuthHttp);
 ...
 */
function tokenNotExpired(tokenName = 'id_token', jwt) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _utility_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utility.service */ "./src/app/shared/utility.service.ts");
/* harmony import */ var _narration_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./narration.service */ "./src/app/shared/narration.service.ts");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../environments/environment */ "./src/environments/environment.ts");
/* harmony import */ var _md5__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./md5 */ "./src/app/shared/md5.ts");
/* harmony import */ var _angular2_jwt__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./angular2-jwt */ "./src/app/shared/angular2-jwt.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AuthService = class AuthService {
    constructor(utility, narrationService) {
        this.utility = utility;
        this.narrationService = narrationService;
    ...
    login(email, password) {
        return new Promise((resolve, reject) => {
            this.utility.makePostRequest("/api/user/login", [], { "user": email, "password": Object(_md5__WEBPACK_IMPORTED_MODULE_4__["md5"])(password) }).then((res) => {
                let result = _utility_service__WEBPACK_IMPORTED_MODULE_1__["UtilityService"].extractData(res);
    ...
    register(email, password) {
        let cUser = { user: email, password: password };
        return new Promise((resolve, reject) => {
            this.utility.makePostRequest("/api/user/signup", [], cUser).then((res) => {
                let result = _utility_service__WEBPACK_IMPORTED_MODULE_1__["UtilityService"].extractData(res);
                let narration = _utility_service__WEBPACK_IMPORTED_MODULE_1__["UtilityService"].extractNarration(res);
...
AuthService = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    __metadata("design:paramtypes", [_utility_service__WEBPACK_IMPORTED_MODULE_1__["UtilityService"], _narration_service__WEBPACK_IMPORTED_MODULE_2__["NarrationService"]])
], AuthService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth.service */ "./src/app/shared/auth.service.ts");
...
/* harmony import */ var _navbar_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navbar.component */ "./src/app/shared/navbar.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NavbarComponent", function() { return _navbar_component__WEBPACK_IMPORTED_MODULE_2__["NavbarComponent"]; });

/* harmony import */ var _narration_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./narration.component */ "./src/app/shared/narration.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NarrationComponent", function() { return _narration_component__WEBPACK_IMPORTED_MODULE_3__["NarrationComponent"]; });

/* harmony import */ var _narration_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./narration.service */ "./src/app/shared/narration.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Narration", function() { return _narration_service__WEBPACK_IMPORTED_MODULE_4__["Narration"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NarrationService", function() { return _narration_service__WEBPACK_IMPORTED_MODULE_4__["NarrationService"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NarrationComponent", function() { return NarrationComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _narration_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./narration.service */ "./src/app/shared/narration.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let NarrationComponent = class NarrationComponent {
...
NarrationComponent.ctorParameters = () => [
    { type: _narration_service__WEBPACK_IMPORTED_MODULE_1__["NarrationService"] }
];
NarrationComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-narration',
        template: __importDefault(__webpack_require__(/*! raw-loader!./narration.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/narration.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./narration.component.css */ "./src/app/shared/narration.component.css")).default]
    }),
    __metadata("design:paramtypes", [_narration_service__WEBPACK_IMPORTED_MODULE_1__["NarrationService"]])
], NarrationComponent);
...
;
let NarrationService = class NarrationService {
    constructor() {
        this.dataArray = [];
...
/* harmony import */ var _utility_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utility.service */ "./src/app/shared/utility.service.ts");
...
NavbarComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-navbar',
        template: __importDefault(__webpack_require__(/*! raw-loader!./navbar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/navbar.component.html")).default
    }),
    __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _utility_service__WEBPACK_IMPORTED_MODULE_2__["UtilityService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
], NavbarComponent);
...
let UtilityService = UtilityService_1 = class UtilityService {
    ...
    makePostRequest(url, params, body, authenticate = false) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.http.request(new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Request"]({
    ...
    makeGetRequestObs(url, params, searchParams, authenticate) {
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({ 'Content-Type': 'application/json' });
        if (authenticate) {
            let token = this.getToken();
            if (token)
        ...
        if (searchParams) {
            let urlSearchParams = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["URLSearchParams"](searchParams);
...
module.exports = __webpack_require__(/*! /Users/ericbishard/dev/sandbox/try-cb-frontend/src/main.ts */"./src/main.ts");
